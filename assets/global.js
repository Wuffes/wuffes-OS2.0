...
class Quiz extends HTMLElement {
  constructor() {
    ...
    this.fullPriceUrl = this.getAttribute('data-redirect-url') ?? false;
    this.jcPdpSbUrl = this.getAttribute('data-redirect-url-pdp-sb') ?? false;
    this.jcPdpLbUrl = this.getAttribute('data-redirect-url-pdp-lb') ?? false;
    this.fetchUrl = this.getAttribute('data-gcloud-url') ?? false;
    this.defaultRedirect = this.getAttribute('data-default-redirect') ?? 'full_price';
